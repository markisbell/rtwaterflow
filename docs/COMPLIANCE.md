...
die qVR-Klassifizierung folgt), Wasserrecht (M6 Brunnen),
W 303-Druckstoß-Hinweis bei Pumpenausfall (Hinweis, nicht gerechnet),
Wasseralter-Proxy (M9 Post-Processing).
